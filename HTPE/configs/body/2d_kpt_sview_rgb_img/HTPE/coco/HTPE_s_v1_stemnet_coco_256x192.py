...
log_level = 'INFO'
load_from = None
resume_from = '/home/sdpose_rotary_keypoint_token_x_y/SDPose/work_dirs/sdpose_s_v1_stemnet_coco_256x192/best_AP_epoch_142.pth'
...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file='/home/coco/person_detection_results/COCO_val2017_detections_AP_H_56_person.json',
)
