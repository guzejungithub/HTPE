...
resume_from =  '/root/autodl-tmp/sdpose-rle_official/work_dirs/tokenpose_coco_256x192_rle/epoch_300.pth'
...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file='/root/autodl-tmp/COCO2017/person_detection_results/COCO_test-dev2017_detections_AP_H_609_person.json',
)
...
data = dict(
    ...
    test_dataloader=dict(samples_per_gpu=480),
    train=dict(
